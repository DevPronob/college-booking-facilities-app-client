  ...
  <div class="relative flex max-w-screen-xl flex-col overflow-hidden px-4 py-4 md:mx-auto md:flex-row md:items-center">
    ...
    <nav aria-label="Header Navigation" class="peer-checked:mt-8 peer-checked:max-h-56 flex max-h-0 w-full flex-col items-center justify-between overflow-hidden transition-all md:ml-24 md:max-h-full md:flex-row md:items-start">
      <ul class="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
        <li class="text-gray-600 md:mr-12 hover:text-blue-600"><Link to="/" >Home</Link></li>
        <li class="text-gray-600 md:mr-12 hover:text-blue-600"><Link to="/colleges">Colleges</Link></li>
        <li class="text-gray-600 md:mr-12 hover:text-blue-600"><Link to="/admission">Admission</Link></li>
        <li class="text-gray-600 md:mr-12 hover:text-blue-600"><Link to="/my-colleges">My Colleges</Link></li>
        <li class="text-gray-600 md:mr-12 hover:text-blue-600"><Link to="/profile">Profile</Link></li>
        <li class="text-gray-600 md:mr-12 hover:text-blue-600">
        <li>{user ? <button className="rounded-xl mt-[-3px] border-2 border-blue-600 px-6 py-2 font-medium text-blue-600 hover:bg-blue-600 hover:text-white" onClick={logout} >Sign Out</button> : <li class="mt-2 sm:mt-0"><Link to="/login" class="rounded-xl border-2 border-blue-600 px-6 py-2 font-medium text-blue-600 hover:bg-blue-600 hover:text-white" >Login</Link></li>}</li>
        </li>
      </ul>
    </nav>
  </div>
